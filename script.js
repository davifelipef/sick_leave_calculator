...
function calcDate() {
    ...
    //gets the total of the days
    var finalDate = accountedDays.length-1;
    //parses the total of the days to number
...
the date*/
    ...
    document.getElementById("result").innerHTML = "A licença de " + y + " dia(s) a partir de " + initdategp + " terminará no dia " + ftdategp + ".";
    //logs used during development
